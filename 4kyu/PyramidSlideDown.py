# Question: https://www.codewars.com/kata/551f23362ff852e2ab000037/train/python
...
def longest_slide_down(pyramid):
    ...
    while pyramid:
        # Update from bottom the solution of each element position
        last = pyramid.pop()
        temp = []
        for i in range(len(last)):
            temp.append(last[i] + max(res[i], res[i+1]))
        res = temp
